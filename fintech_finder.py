...
candidate_database = {
    "Lane": ["Lane", "0xaC8eB8B2ed5C4a0fC41a84Ee4950F417f67029F0", "4.3", .20, "Solidity, Ruby, Python, SQL", "Blockchain & Machine Learning Projects", "Images/lane.jpeg", "Emojis/DataGeek.png"],
...
st.sidebar.write("If you hire", candidate, "for", hours, "hours, the total wage will be", wage, "ether.")
